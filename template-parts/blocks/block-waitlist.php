...
?>
<div class="b-waitlist <?php echo isset($block['className']) ? $block['className'] : ''; ?>" id="waitlist" data-aos="fade-up">
        ...
        <div class="b-waitlist__wrapper">   
            ...
            <div class="b-waitlist__groups">
                <div class="b-groups">
                    ...
                    <div class="b-groups__item <?php echo $x==0 ? 'first' : ''; ?> <?php echo $x == $total - 1 ? 'last' : ''; ?>">
